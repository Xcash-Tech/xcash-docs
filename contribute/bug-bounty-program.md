...
* **XCASH\_DPOPS -** [**GitHub**](https://github.com/xcash-tech/XCASH_DPOPS)
* **XCASH\_DPOPS\_Delegates\_Website -** [**GitHub**](https://github.com/xcash-tech/XCASH_DPOPS_delegates_website)
...
The above conditions remains indicative and any out-of-scope vulnerabilities will be assessed on a case-by-case basis. The X-Cash Tech team member remains responsible for accepting or rejecting vulnerabilities at their own discretion although a justification will be provided.
...
{% hint style="warning" %}
If the vulnerability is considered critical \(CVSS&gt;8.0, leading to monetary supply generation or from reporter self-assessment\), please send the report directly to **security@xcash.tech**, we will assess the severity and advise if a non-disclosure period is required.
{% endhint %}
...
Any activities conducted in a manner consistent with this policy will be considered authorized conduct and the X-Cash Tech will not initiate legal action against the hacker. If legal action is initiated by a third party against the hacker or in connection with activities conducted under this policy, the X-Cash Tech will take steps to make it known that actions were conducted in compliance with this policy.
